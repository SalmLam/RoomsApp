...
$(window).on("load", function() {
    ...
    $(".post-project > a").on("click", function(){
     ...
     $(".close-box").on("click", function(){
        $("#post-popup-id").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    ...
    */
    ...
    $(".abn-open").on("click", function(){
        $("#abn-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#abn-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });

    /*abonnés*/
     $(".abne-open").on("click", function(){
        $("#abne-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#abne-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
